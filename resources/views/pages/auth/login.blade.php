...
<html lang="en">
    ...
    <body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-10">
                        <div class="wrap d-md-flex">
                            <div class="img" style="background-image: url({{ asset('login-asset/images/bg-1.jpg') }});"></div>
        ...
        <script src="{{ asset('login-asset/js/jquery.min.js') }}"></script>
        <script src="{{ asset('login-asset/js/popper.js') }}"></script>
